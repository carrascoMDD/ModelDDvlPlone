...
def InformeContenidoZipFile( thePath, theZipFileName,  theRootDir='', theIsWindows=False):
...
def DescomprimirContenidoZipFile( thePath, theZipFileName,  theRootDir='',  theIsWindows=False):

    unContentReport = InformeContenidoZipFile(  thePath, theZipFileName, theRootDir, theIsWindows )
