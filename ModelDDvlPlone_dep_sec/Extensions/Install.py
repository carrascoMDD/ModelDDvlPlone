...
from Products.ModelDDvlPlone.config import PROJECTNAME
from Products.ModelDDvlPlone.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install ModelDDvlPlone """
    out = StringIO()
    ...
    try:
        from Products.ModelDDvlPlone.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.ModelDDvlPlone.config import STYLESHEETS
    try:
        ...
        pass
    from Products.ModelDDvlPlone.config import JAVASCRIPTS
    try:
